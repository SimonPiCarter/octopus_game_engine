...
int main()
{
	...
	octopus::Entity building_l { {-5, 5}, true, buildingModel_l };

	std::list<octopus::Steppable *> spawners_l =
	{
		new octopus::EntitySpawnStep(octopus::Entity { { 3.6, 3. }, false, unitModel_l}),
		new octopus::EntitySpawnStep(octopus::Entity { { 5.1, 3.1 }, false, unitModel_l}),
		new octopus::EntitySpawnStep(octopus::Entity { { 6.5, 3. }, false, unitModel_l}),
		new octopus::EntitySpawnStep(octopus::Entity { { 3.5, 3.6 }, false, unitModel_l}),
		new octopus::EntitySpawnStep(octopus::Entity { { 5., 3.4 }, false, unitModel_l}),
		new octopus::EntitySpawnStep(octopus::Entity { { 6.4, 3.5 }, false, unitModel_l}),
		new octopus::EntitySpawnStep(octopus::Entity { { 3.2, 2.4 }, false, unitModel_l}),
		new octopus::EntitySpawnStep(octopus::Entity { { 5.1, 2.5 }, false, unitModel_l}),
		new octopus::EntitySpawnStep(octopus::Entity { { 6.5, 2.6 }, false, unitModel_l}),
