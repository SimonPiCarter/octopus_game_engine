...
void runLevel1(Window &window_p)
{
	...
	StatsPanel statsPanel_l(&window_p, window_p.getWidth()-520, window_p.getHeight()-260,
		window_p.loadTexture("resources/background.png"), window_p.loadTexture("resources/grid.png"), window_p.loadTexture("resources/grid.png"), 4, world_l.getSelection());
	...
	spriteLib_l.registerSpriteTemplate("resource_ether", window_p.loadTexture("resources/ether_prop1.png"), 2., 64, 64, 128, 128, {10, 1}, {0.2, 1.5}, 1);
	spriteLib_l.registerSpriteTemplate("resource_gas", window_p.loadTexture("resources/gas_prop1.png"), 2., 64, 64, 128, 128, {20, 1}, {0.1, 1.5}, 1);
	...
	spriteLib_l.registerSpriteTemplate("deposit", window_p.loadTexture("resources/deposit.png"), 1., 32, 32, 64, 64, {2, 2, 2, 2}, {0.25, 0.5, 0.5, 0.5}, 1);
	spriteLib_l.registerSpriteTemplate("ether_deposit", window_p.loadTexture("resources/ether_deposit.png"), 1., 32, 32, 64, 64, {2, 2, 2, 2}, {0.25, 0.5, 0.5, 0.5}, 1);
	spriteLib_l.registerSpriteTemplate("temple", window_p.loadTexture("resources/temple.png"), 1., 32, 32, 64, 64, {2, 2, 2, 2}, {0.25, 0.5, 0.5, 0.5}, 1);
	spriteLib_l.registerSpriteTemplate("abandonned_temple", window_p.loadTexture("resources/temple.png"), 1., 32, 32, 64, 64, {2, 2, 2, 2}, {0.25, 0.5, 0.5, 0.5}, 1);
	spriteLib_l.registerSpriteTemplate("worker", window_p.loadTexture("resources/worker.png"), 0.5, 32, 32, 64, 64, {2, 2}, {0.25, 1}, 1);

	spriteLib_l.registerSpriteTemplate("div_armor_well", window_p.loadTexture("resources/well_2.png"), 1., 32, 32, 64, 64, {6, 1, 1, 1}, {0.25, 0.5, 0.5, 0.5}, 1);
	spriteLib_l.registerSpriteTemplate("div_fire_well", window_p.loadTexture("resources/well_4.png"), 1., 32, 32, 64, 64, {6, 1, 1, 1}, {0.25, 0.5, 0.5, 0.5}, 1);
	spriteLib_l.registerSpriteTemplate("div_raid_well", window_p.loadTexture("resources/well_1.png"), 1., 32, 32, 64, 64, {6, 1, 1, 1}, {0.25, 0.5, 0.5, 0.5}, 1);
	spriteLib_l.registerSpriteTemplate("div_swarm_well", window_p.loadTexture("resources/well_3.png"), 1., 32, 32, 64, 64, {6, 1, 1, 1}, {0.25, 0.5, 0.5, 0.5}, 1);

	spriteLib_l.registerSpriteTemplate("div_armor_1", window_p.loadTexture("resources/soldier2_1.png"), 0.5, 32, 32, 64, 64, {2, 2}, {0.25, 1}, 1);
	spriteLib_l.registerSpriteTemplate("div_armor_2", window_p.loadTexture("resources/soldier2_2.png"), 0.5, 32, 32, 64, 64, {2, 2}, {0.25, 1}, 1);
	spriteLib_l.registerSpriteTemplate("div_armor_3", window_p.loadTexture("resources/soldier2_3.png"), 0.75, 32, 32, 64, 64, {2, 2}, {0.25, 1}, 1);

	spriteLib_l.registerSpriteTemplate("div_fire_1", window_p.loadTexture("resources/soldier4_1.png"), 0.5, 32, 32, 64, 64, {2, 2}, {0.25, 1}, 1);
	spriteLib_l.registerSpriteTemplate("div_fire_2", window_p.loadTexture("resources/soldier4_2.png"), 0.5, 32, 32, 64, 64, {2, 2}, {0.25, 1}, 1);
	spriteLib_l.registerSpriteTemplate("div_fire_3", window_p.loadTexture("resources/soldier4_3.png"), 0.5, 32, 32, 64, 64, {2, 2}, {0.25, 1}, 1);

	spriteLib_l.registerSpriteTemplate("div_raid_1", window_p.loadTexture("resources/soldier1_1.png"), 0.5, 32, 32, 64, 64, {2, 2}, {0.25, 1}, 1);
	spriteLib_l.registerSpriteTemplate("div_raid_2", window_p.loadTexture("resources/soldier1_2.png"), 0.75, 32, 32, 64, 64, {2, 2}, {0.25, 1}, 1);
	spriteLib_l.registerSpriteTemplate("div_raid_3", window_p.loadTexture("resources/soldier1_3.png"), 0.5, 32, 32, 64, 64, {2, 2}, {0.25, 1}, 1);

	spriteLib_l.registerSpriteTemplate("div_swarm_1", window_p.loadTexture("resources/soldier3_1.png"), 0.35, 32, 32, 64, 64, {2, 2}, {0.25, 1}, 1);
	spriteLib_l.registerSpriteTemplate("div_swarm_2", window_p.loadTexture("resources/soldier3_2.png"), 0.5, 32, 32, 64, 64, {2, 2}, {0.25, 1}, 1);
	spriteLib_l.registerSpriteTemplate("div_swarm_3", window_p.loadTexture("resources/soldier3_3.png"), 0.5, 32, 32, 64, 64, {2, 2}, {0.25, 1}, 1);
