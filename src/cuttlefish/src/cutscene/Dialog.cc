...
Dialog::Dialog(Window* window_p, int x, int y, Picture const & background_p,
    ...
    , _icon(icon_p)
    , _textReturn(window_p, {0,0,0}, x+550, y+155)
{
    ...
    _textReturn.setText(return_p);
    _textReturn.setPosition(x+655-_textReturn.getWidth(), y+155);
}
