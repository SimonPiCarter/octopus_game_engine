...
public:
	...
	void handleStep(Window &window_p, Panel &panel_p, StatsPanel &statsPanel_p, OptionPanel &optionPanel_p, octopus::StateAndSteps const &steps_p, SpriteLibrary const &lib_p, double &x, double &y);
