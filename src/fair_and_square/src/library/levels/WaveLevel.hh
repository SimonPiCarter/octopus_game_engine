...
public:
	...
	virtual void trigger(octopus::State const &state_p, octopus::CommandContext const &, octopus::Step &step_p, unsigned long, octopus::TriggerData const &) const override;
