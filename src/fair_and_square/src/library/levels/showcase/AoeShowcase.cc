...
#include "state/entity/attackModifier/modifiers/AoEModifier.hh"
...
std::list<Steppable *> aoeShowcaseSteps(Library &lib_p, uint32_t number_p)
{
    // square
{
    ...
    // triangle
{
	...
	square1_l._player = 0;
    square1_l._attackMod = AoEModifier(0.5, 5);
...
std::list<Command *> aoeShowcaseCommands(Library &lib_p)
{
	return {};
}
