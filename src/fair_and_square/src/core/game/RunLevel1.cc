...
#include "library/levels/Level1.hh"
...
void runLevel1(Window &window_p, unsigned long stepCount_p, unsigned long worldSize_p, unsigned long seed_p)
{
	...
	std::list<octopus::Steppable *> spawners_l = fas::level1::WaveLevelSteps(lib_l, rand_l, 10, stepCount_p, worldSize_p, std::bind(genDialogStep, window_p));
