...
{
public:
	TriggerModel(std::list<octopus::Listener *> const &listeners_p, GodotTriggerAction const &trigger_p, octopus::Library const &lib_p, unsigned long playerCount_p);
...
private:
	GodotTriggerAction const _triggerAction;
