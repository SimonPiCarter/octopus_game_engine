...
class SimulationVisitor : public octopus::SteppableVisitor
{
public:
	SimulationVisitor(SimulationNode *simulation_p)
		: _simulation(simulation_p) {}
	...
	virtual void visit(octopus::CommandMoveUnlockRoutineStep const *) override {}
	...
	virtual void visit(octopus::PlayerPopOptionStep const *) override {}
...
private:
    SimulationNode * const _simulation;
};
