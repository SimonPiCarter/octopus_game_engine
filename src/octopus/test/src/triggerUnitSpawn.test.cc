...
TEST(triggerUnitSpawnTest, two_players)
{
	...
	// unit production
	BuildingUnitProductionCommand * command0_l = new BuildingUnitProductionCommand(Handle(0), Handle(0), unitModel_l);
	BuildingUnitProductionCommand * command1_l = new BuildingUnitProductionCommand(Handle(1), Handle(1), unitModel_l);

	Controller controller_l({
		new PlayerSpawnStep(0, 0),
		new PlayerSpawnStep(1, 0),
		new BuildingSpawnStep(Handle(0), productionPlayer0_l, true),
		new BuildingSpawnStep(Handle(1), productionPlayer1_l, true),
...
TEST(triggerUnitSpawnTest, two_models)
{
	...
	// unit production
	BuildingUnitProductionCommand * command0_l = new BuildingUnitProductionCommand(Handle(0), Handle(0), unitModel0_l);
	BuildingUnitProductionCommand * command1_l = new BuildingUnitProductionCommand(Handle(1), Handle(1), unitModel1_l);

	Controller controller_l({
		new PlayerSpawnStep(0, 0),
		new BuildingSpawnStep(Handle(0), production0_l, true),
		new BuildingSpawnStep(Handle(1), production1_l, true),
		new CommandSpawnStep(command0_l),
		new CommandSpawnStep(command1_l)
	}, 1.);
...
TEST(triggerUnitSpawnTest, one_model)
{
	...
	// unit production
	BuildingUnitProductionCommand * command0_l = new BuildingUnitProductionCommand(Handle(0), Handle(0), unitModel0_l);
	BuildingUnitProductionCommand * command1_l = new BuildingUnitProductionCommand(Handle(1), Handle(1), unitModel0_l);
