...
TEST(harvestCommandTest, simple)
{
	...
	EXPECT_NEAR(5.5, state_l->getEntity(0)->_pos.x.to_double(), 1e-5);
	EXPECT_NEAR(3.5, state_l->getEntity(0)->_pos.y.to_double(), 1e-5);
	...
	EXPECT_NEAR(6.5, state_l->getEntity(0)->_pos.x.to_double(), 1e-5);
	EXPECT_NEAR(3.5, state_l->getEntity(0)->_pos.y.to_double(), 1e-5);
	...
	EXPECT_NEAR(7.5, state_l->getEntity(0)->_pos.x.to_double(), 1e-5);
	EXPECT_NEAR(3.5, state_l->getEntity(0)->_pos.y.to_double(), 1e-5);
	...
	EXPECT_NEAR(3.5, state_l->getEntity(0)->_pos.x.to_double(), 1e-5);
	EXPECT_NEAR(3.5, state_l->getEntity(0)->_pos.y.to_double(), 1e-5);
	EXPECT_EQ(ResourceType::Food, stateUnit_l->_typeOfResource);
	EXPECT_NEAR(10., stateUnit_l->_quantityOfResource, 1e-5);
