...
namespace RVO {
	 ...
	 */
	inline octopus::Fixed distSqPointLineSegment(const Vector2 &a, const Vector2 &b,
										const Vector2 &c)
	{
		const octopus::Fixed r = ((c - a) * (b - a)) / absSq(b - a);
	 ...
	 */
	inline octopus::Fixed leftOf(const Vector2 &a, const Vector2 &b, const Vector2 &c)
	{
		return det(a - c, b - a);
	}
}
