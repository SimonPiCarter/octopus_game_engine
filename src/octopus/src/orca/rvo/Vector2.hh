...
namespace RVO {
	...
	public:
		 ...
		 */
		inline octopus::Fixed operator*(const Vector2 &vector) const
		{
		 ...
		 */
		inline Vector2 operator*(octopus::Fixed s) const
		{
		...
		inline Vector2 operator/(octopus::Fixed s) const
		{
			const octopus::Fixed invS = 1.0 / s;
		 ...
		 */
		inline Vector2 &operator*=(octopus::Fixed s)
		{
			x_ *= s;
			y_ *= s;
	 ...
	 *             scalar value.
	 */
	inline Vector2 operator*(octopus::Fixed s, const Vector2 &vector)
	{
	 ...
	 */
	inline octopus::Fixed abs(const Vector2 &vector)
	{
		return numeric::square_root(vector * vector);
	}
	 ...
	 */
	inline octopus::Fixed absSq(const Vector2 &vector)
	{
	 ...
	 */
	inline octopus::Fixed det(const Vector2 &vector1, const Vector2 &vector2)
	{
