...
namespace octopus
{
	...
	class SteppableVisitor
	{
		public:
			...
			virtual void visit(PlayerAddOptionDivinityStep const *) = 0;
			virtual void visit(PlayerAddOptionStep const *) = 0;
			virtual void visit(PlayerAttackModAllStep const *) = 0;
			virtual void visit(PlayerAnchorDivinityStep const *) = 0;
			virtual void visit(PlayerBuffAllStep const *) = 0;
			virtual void visit(PlayerLevelUpDivinityStep const *) = 0;
			virtual void visit(PlayerPopOptionStep const *) = 0;
			virtual void visit(PlayerResetOptionDivinityStep const *) = 0;
